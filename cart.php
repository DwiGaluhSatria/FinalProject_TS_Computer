	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>DAPATKAN PENAWARAN MENARIK KHUSUS HARI INI, <a href="product.php">BELANJA SEKARANG!</a></p>
			</div>
								...
								<td class="invert">
									<div class="quantity">
										<div class="quantity-select">
											<input type="number" name="jumlah" class="form-control" height="100px" value="<?php echo $b['qty'] ?>" min="1" max="<?php echo $b['stok_produk'] ?>" \>
										</div>
									</div>
								</td>
		...
		<div class="checkout-left">
			<div class="checkout-left-basket">
				...
				<ul>
					...
					?>
					<li>Total (Belum Inc. Ongkir)<i> - </i> <span>Rp<?php echo number_format($subtotal) ?></span></li>
				</ul>
			</div>
