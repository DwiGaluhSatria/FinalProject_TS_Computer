...
if (isset($_POST['editcategory'])) {
    $namakategori = $_POST['unamakategori'];
    $id = $_POST['uid'];

    $editkat = mysqli_query($conn, "UPDATE `kategori` SET `namakategori` = '$namakategori' WHERE `idkategori` = '$id'");
    if ($editkat) {
        echo "
		<meta http-equiv='refresh' content='1; url= kategori.php'/>  ";
    } else {
...
<head>
    ...
    <title>Kelola Kategori - Tech Syndrome Computer</title>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="hapuskategori.php?kategoriid=<?php echo $id; ?>" class="btn btn-info">Hapus</button>
                                                    </td>
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="post">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="unamakategori" type="text" class="form-control" value="<?php echo $p['namakategori'] ?>" required autofocus>
                                                                    </div>
