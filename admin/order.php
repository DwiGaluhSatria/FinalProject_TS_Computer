...
if (isset($_POST['kirim'])) {
	...
	if ($updatestatus && $del) {
		echo " <script> alert('Barang Dalam Pengiriman');
		document.location.href = 'manageorder.php';
	</script>";
		...
		echo " <script> alert('Pengiriman Gagal');
		document.location.href = 'manageorder.php';
	</script>";
...
if (isset($_POST['selesai'])) {
	...
	if ($updatestatus) {
		echo " <script> alert('Transaksi Diselesaikan');
		document.location.href = 'manageorder.php';
	</script>";
		// echo " <div class='alert alert-success'>
...
<head>
	...
	<title>Tech Syndrome Computer - Pesanan <?php echo $checkdb['namalengkap']; ?></title>
