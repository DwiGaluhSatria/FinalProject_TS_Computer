...
if (isset($_POST['confirm'])) {
	...
	if ($fetch > 0) {
		...
		if ($kon) {
			...
			echo " <script> alert('Terima kasih telah melakukan konfirmasi, team kami akan melakukan verifikasi. Informasi selanjutnya akan dikirim via Email');
		...
		echo " <script> alert('Kode Order tidak ditemukan, harap masukkan kembali dengan benar');
...
<head>
	<title>Tech Syndrome Computer - Konfirmasi Pembayaran</title>
	<!-- for-mobile-apps -->
