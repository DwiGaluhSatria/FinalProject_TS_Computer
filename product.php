...
if (isset($_POST['addprod'])) {
	if (!isset($_SESSION['log'])) {
		...
		//kalo ternyata sudah ada order id nya
		if ($liat > 0) {
			...
			//kalo ternyata barangnya sudah ada
			if ($liatlg > 0) {
				$i = 1;
				$baru = $jmlh + $i;
...
<head>
	<title>Tech Syndrome Computer- Produk</title>
	<!-- for-mobile-apps -->
		...
		<div class="container">
			<div class="agileinfo_single">
				...
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="w3agile_description">
						<h4>Berat :</h4>
						<p><?php echo $p['berat_produk'] ?> gr </p>
					</div>
					<div class="w3agile_description">
						<h4>Stok Tersedia :</h4>
						<p><?php if ($p['stok_produk'] == 0) {
								echo 'Stok Habis!';
							} else {
								echo $p['stok_produk']
							?> unit <?php } ?></p>
						...
						<div class="snipcart-details agileinfo_single_right_details">
							<form action="#" method="post">
								<fieldset>
									...
									<input type="submit" name="addprod" value="Tambah Ke Keranjang" class="button" <?php if ($p['stok_produk'] == 0) { ?> hidden <?php } ?>>
								</fieldset>
							</form>
						</div>
					</div>
